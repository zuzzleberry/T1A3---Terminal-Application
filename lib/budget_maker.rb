...
def display_budget(name, income, rent, bills, groceries, debts, transport, entertainment, personal, other)
    ...
    puts "Monthly budget: $#{income - rent - bills - groceries - debts - transport - entertainment - personal - other}".green
end
